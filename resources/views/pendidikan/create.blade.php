    ...
    <main class="dashboard-main">
        <div class="topbar">
            <div class="topbar-title">
                <h2>Tambah Riwayat Pendidikan</h2>
                <p>Masukkan data pendidikan terbaru Anda.</p>
            </div>
        </div>

        <div class="content-card">
            <form method="POST" action="{{ route('alumni.pendidikan.store') }}">
                @csrf
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="institusi" id="institusi" class="form-control" value="{{ old('institusi') }}" placeholder="Nama sekolah/universitas" required>
                    @error('institusi') <small style="color:#DC2626;margin-top:4px;display:block;">{{ $message }}</small> @enderror
                </div>

                <div class="form-group">
                    <label for="jurusan">Jurusan</label>
                    <input type="text" name="jurusan" id="jurusan" class="form-control" value="{{ old('jurusan') }}" placeholder="IPA, IPS, Teknik Informatika, dll">
                ...
                <div class="form-row">
                    <div class="form-group">
                        ...
                        <input type="number" name="tahun_masuk" id="tahun_masuk" class="form-control" value="{{ old('tahun_masuk') }}" placeholder="2020" min="1900" max="2099">
                        @error('tahun_masuk') <small style="color:#DC2626;margin-top:4px;display:block;">{{ $message }}</small> @enderror
                    </div>
                    <div class="form-group">
                        <label for="tahun_lulus">Tahun Lulus</label>
                        <input type="number" name="tahun_lulus" id="tahun_lulus" class="form-control" value="{{ old('tahun_lulus') }}" placeholder="2024" min="1900" max="2099">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="ipk" id="ipk" class="form-control" value="{{ old('ipk') }}" placeholder="3.50">
